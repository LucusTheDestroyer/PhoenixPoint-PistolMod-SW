...
- PistolProficiencyModConfig.cs: Example of ModConfig for custom mod settings;
- PistolProficiencyModGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- PistolProficiencyModMain.cs: Main mod class, recieves mod management and general events;
- PistolProficiencyModTactical.cs: Example of ModTactical for modifying tactical level;
